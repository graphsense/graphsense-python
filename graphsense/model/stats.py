...
class Stats(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currencies, request_timestamp, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currencies, request_timestamp, version, *args, **kwargs):  # noqa: E501
        """Stats - a model defined in OpenAPI
