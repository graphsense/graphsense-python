...
class TxAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, tx_hash, height, timestamp, value, from_address, to_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, tx_hash, height, timestamp, value, from_address, to_address, *args, **kwargs):  # noqa: E501
        """TxAccount - a model defined in OpenAPI
