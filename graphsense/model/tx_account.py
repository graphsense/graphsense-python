...
class TxAccount(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, from_address, height, timestamp, to_address, tx_hash, value, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, from_address, height, timestamp, to_address, tx_hash, value, *args, **kwargs):  # noqa: E501
        """TxAccount - a model defined in OpenAPI
