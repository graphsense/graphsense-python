...
class Entity(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, entity, first_tx, in_degree, last_tx, no_addresses, no_incoming_txs, no_outgoing_txs, out_degree, root_address, total_received, total_spent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, entity, first_tx, in_degree, last_tx, no_addresses, no_incoming_txs, no_outgoing_txs, out_degree, root_address, total_received, total_spent, *args, **kwargs):  # noqa: E501
        """Entity - a model defined in OpenAPI
