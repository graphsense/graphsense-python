...
class Tag(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, tagpack_title, tagpack_is_public, tagpack_creator, is_cluster_definer, currency, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, tagpack_title, tagpack_is_public, tagpack_creator, is_cluster_definer, currency, *args, **kwargs):  # noqa: E501
        """Tag - a model defined in OpenAPI
