...
class SearchResultLevel2(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, matching_addresses, neighbor, paths, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, matching_addresses, neighbor, paths, *args, **kwargs):  # noqa: E501
        """SearchResultLevel2 - a model defined in OpenAPI
