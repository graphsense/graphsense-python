...
class Actor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, categories, id, jurisdictions, label, uri, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, categories, id, jurisdictions, label, uri, *args, **kwargs):  # noqa: E501
        """Actor - a model defined in OpenAPI
