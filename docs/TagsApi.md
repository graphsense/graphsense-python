...
------------- | ------------- | -------------
[**list_address_tags**](TagsApi.md#list_address_tags) | **GET** /tags | Returns the address tags associated with a given label
...
# **list_address_tags**
> [AddressTag] list_address_tags(label)
...
with graphsense.ApiClient(configuration) as api_client:
    ...
    try:
        # Returns the address tags associated with a given label
        api_response = api_instance.list_address_tags(label, currency=currency)
        pprint(api_response)
    except graphsense.ApiException as e:
        print("Exception when calling TagsApi->list_address_tags: %s\n" % e)
```
